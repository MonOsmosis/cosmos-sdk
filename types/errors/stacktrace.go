...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/MonOsmosis/cosmos-sdk/types/errors.Wrap",
		"github.com/MonOsmosis/cosmos-sdk/types/errors.Wrapf",
		"github.com/MonOsmosis/cosmos-sdk/types/errors.WithType",
